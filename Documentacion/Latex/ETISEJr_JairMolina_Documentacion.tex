...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.95\textwidth,page=1]{img/esquematico.pdf}}
...
\subsection{Diseño final ruteado PCB v6}
...
de optimización, con verificación automática de: presencia de los 53 refs,
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.92\textwidth]{img/top.png}
  \caption{Vista superior (Top Layer) del PCB v6 ruteado: bloque lógico/analógico a la izquierda, potencia a la derecha, NT1 al centro.}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.92\textwidth]{img/bottom.png}
  \caption{Vista inferior (Bottom Layer) del PCB v6 ruteado. Se aprecian los planos de tierra divididos (AGND y PGND) y el ruteo de potencia.}
\end{figure}
